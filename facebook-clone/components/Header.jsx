  ...
  return (
    <div className="bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16">
      <div className="flex min-w-fit">
        <Image src="/facebook_logo.png" height={40} width={40} />
        <div className="flex items-center space-x-2 px-2 ml-2 rounded-full bg-gray-100 text-gray-500">
          <HiOutlineSearch size={20} />
          <input
            className="hidden lg:inline-flex bg-gray-100 focus:outline-none"
            type="text"
      ...
      <div className="flex flex-grow justify-center mx-2">
        {/*flex-grow is for resopsiveness */}
        <div className="flex items-center">
          <div
            className="flex items-center h-14 px-4 md:px-10 rounded-md md:hover:bg-gray-100 
            cursor-pointer"
          >
